...
const Products: FC = () => {
  return (
    <>
      <Navbar></Navbar>
      <Hero desc="Products and Services" image={productsHero}></Hero>
      ...
      <section className="flex flex-col px-6 md:px-48 justify-center py-20 gap-10">
        <h1 className="text-3xl md:text-5xl text-center">Our Approach</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-40 py-20">
